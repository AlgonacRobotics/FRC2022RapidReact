...
public class LauncherSpitCommandGroup extends ParallelCommandGroup {
  /** Creates a new LauncherSpitCommandGroup. */
  public LauncherSpitCommandGroup() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new LauncherSpitCommand(), new IndexerInCommand(), new TowerUpCommand());
  }
}
